...
public class GbGradebookData {
    ...
    private List<String[]> courseGrades() {
        ...
        for (GbStudentGradeInfo studentGradeInfo : this.studentGradeInfoList) {
            ...
            GbCourseGrade courseGrade = studentGradeInfo.getCourseGrade();

            gradeData[0] = courseGrade.getDisplayString();
            gradeData[1] = FormatHelper.formatDoubleToTwoDecimalPlaces(courseGrade.getCourseGrade().getPointsEarned());
