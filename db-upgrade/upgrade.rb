...
run_block(36, "Add missing columns for Turnitin",
          "
ALTER TABLE CONTENTREVIEW_ITEM ADD \"VERSION\" INTEGER DEFAULT 0 NOT NULL;
ALTER TABLE CONTENTREVIEW_ITEM ADD \"PROVIDERID\" INTEGER DEFAULT 1571541951 NOT NULL;
")


run_block(37, "SAK-32101 Change the column REVIEW_COMMENT of ASN_PEER_ASSESSMENT_ITEM_T from LONG to CLOB",
          "
ALTER TABLE ASN_PEER_ASSESSMENT_ITEM_T modify (REVIEW_COMMENT CLOB);
"
)

run_block(38, "Add missing index for ASN_SUBMISSION_ATTACHMENTS",
          "
CREATE INDEX IDX_ASN_SUBMISSION_ATTACH ON ASN_SUBMISSION_ATTACHMENTS (SUBMISSION_ID);
")
